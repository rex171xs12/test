...
import static com.appd.instll.shalter.Utility.PRIM_INSTLL_APPS;
import static com.appd.instll.shalter.Utility.autoSetPermission;
import static com.appd.instll.shalter.Utility.pref_install_app;
...
public class DummyActivity extends Activity {
    public static final String FINALIZE_PROVISION = "ACT.INT.INT.ID.FINALIZE_PROVISION";
    public static final String START_SERVICE = "ACT.INT.INT.ID.START_SERVICE";
    public static final String TRY_START_SERVICE = "ACT.INT.INT.ID.TRY_START_SERVICE";
    public static final String INSTALL_PACKAGE = "ACT.INT.INT.ID.INSTALL_PACKAGE";
    public static final String UNINSTALL_PACKAGE = "ACT.INT.INT.ID.UNINSTALL_PACKAGE";
    public static final String UNFREEZE_AND_LAUNCH = "ACT.INT.INT.ID.UNFREEZE_AND_LAUNCH";
    public static final String PUBLIC_UNFREEZE_AND_LAUNCH = "ACT.INT.INT.ID.PUBLIC_UNFREEZE_AND_LAUNCH";
    public static final String PUBLIC_FREEZE_ALL = "ACT.INT.INT.ID.PUBLIC_FREEZE_ALL";
    public static final String FREEZE_ALL_IN_LIST = "ACT.INT.INT.ID.FREEZE_ALL_IN_LIST";
    //public static final String DESTROY = "ACT.INT.INT.ID.DESTROY";
    ...
    public static final String START_FILE_SHUTTLE = "ACT.INT.INT.ID.START_FILE_SHUTTLE";
    public static final String START_FILE_SHUTTLE_2 = "ACT.INT.INT.ID.START_FILE_SHUTTLE_2";
    public static final String SYNCHRONIZE_PREFERENCE = "ACT.INT.INT.ID.SYNCHRONIZE_PREFERENCE";
    public static final String PACKAGEINSTALLER_CALLBACK = "ACT.INT.INT.ID.PACKAGEINSTALLER_CALLBACK";
...
//        }
        ...
        if (START_SERVICE.equals(intent.getAction())) {
            ...
            Log.d("actionUninstall","first call");
        ...
        if (intent.getAction().equals(PACKAGEINSTALLER_CALLBACK)) {
            ...
            switch (status) {
                ...
                case PackageInstaller.STATUS_SUCCESS:
                    ...
                    Intent bridgeintent = new Intent(MyBridge.BR_REFRESH);
    ...
    private void actionInstallPackage() {
        ...
        try {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                ...
                boolean alreadySet = prefs.getBoolean(pref_install_app, false);

                boolean canInstall = getPackageManager().canRequestPackageInstalls();
                //Toast.makeText(this, "caninstall: " + canInstall, Toast.LENGTH_SHORT).show();

                if (!canInstall && !alreadySet) {
                    // Mark it as done
                    prefs.edit().putBoolean(pref_install_app, true).apply();
                    autoSetPermission(this, getPackageName(), PRIM_INSTLL_APPS);
    ...
    private void actionUnfreezeAndLaunch() {
        ...
        if (launchIntent != null) {
           ...
           // Toast.makeText(this, "cannot be launched", Toast.LENGTH_SHORT).show();
        }
    ...
    private void actionFreezeAllInList() {
        if (mIsProfileOwner) {
            ...
            //Toast.makeText(this, "FreezeAll", Toast.LENGTH_SHORT).show();
            finish();
        } else {
            finish();
        }
    ...
    private void doStartFileShuttle() {
        ((MyApplication) getApplication()).bindFileShuttleService(new ServiceConnection() {
            @Override
            public void onServiceConnected(ComponentName name, IBinder service) {
